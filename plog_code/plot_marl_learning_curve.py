...
# 核心路径动态配置 —— 替换为你指定的绝对路径
LOG_DIR = r"C:\Users\DJI\Desktop\dissertation\3JucRL\防覆盖log\01 pressure 500000"

# 提取文件夹名称用于作图的标题和保存的文件名
...
def plot_marl_learning_curve():
    ...
    ax1.set_title(f'{RUN_NAME}：回合数 vs 平均等待时间', fontsize=15, fontweight='bold')
    ...
    ax2.set_title(f'{RUN_NAME}：回合数 vs 平均排队长度', fontsize=15, fontweight='bold')
    ...
    # 图片自动保存在指定的数据文件夹下
    save_path = os.path.join(LOG_DIR, f"{RUN_NAME}_learning_curves.png")
